...
void wifi_init_sta(char *ssid, char *pass) { s_wifi_event_group = xEventGroupCreate(); }
...
esp_err_t wifi_init() {
  // check data cache for existing ssid/pass
  ESP_LOGI(TAG, "wifi initialized\n");
  return ESP_OK;
}

bool wifi_attempt_connect_to(char *ssid, char *password) {
