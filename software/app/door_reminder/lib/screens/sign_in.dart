  ...
  Widget showEmailInput() {
    return Padding(
      ...
      child: new TextFormField(
        ...
        validator: (value) => value.isEmpty ? 'Email should\'t be empty' : null,
  ...
  Widget showPasswordConfirm() {
    return Padding(
      ...
      child: new TextFormField(
        ...
        validator: (value) =>
            (value.trim() != _password) ? 'Passwords don\'t match' : null,
        onSaved: (value) => _password = value.trim(),
      ),
    );
  }
